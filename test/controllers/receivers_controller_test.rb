...
class ReceiversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receiver" do
    assert_difference('Receiver.count') do
      post receivers_url, params: { receiver: { name: @receiver.name, phone_number: @receiver.phone_number, user_id: @receiver.user_id } }
    end
  ...
  test "should update receiver" do
    patch receiver_url(@receiver), params: { receiver: { name: @receiver.name, phone_number: @receiver.phone_number, user_id: @receiver.user_id } }
